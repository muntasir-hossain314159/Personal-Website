...
layout = dbc.Container([
    dbc.Row(html.H1('Awards'), className='mt-4 mb-4 text-center'),
    dbc.Row([
        dbc.Col([
            html.B("Finalist at Hackillinois 2024", style={"font-size": "large"}),
            html.P("Feb 2024", style={"color": "white"}),
            html.Img(src="./assets/images/Hackillinois_Finalist.jpg", style={"border-radius": "25px", "width": "100%"}),
        ], lg={'size': 6}),
    ...
    dbc.Row([
        dbc.Col([
            ...
            html.Img(src="./assets/images/Capstone_Pitch_Competition.jpg", style={"border-radius": "25px", "width": "100%"}),
        ], lg={'size': 6}),
    ], justify='center', className='mb-4'),
    dbc.Row([
        dbc.Col([
            ...
            html.P("May 2023", style={"color": "white"}),
            html.Img(src="./assets/images/Honors_Program.JPG", style={"border-radius": "25px", "width": "100%"}),
        ], lg={'size': 6}),
    ], justify='center', className='mb-4'),
    dbc.Row([
        dbc.Col([
            ...
            html.Img(src="./assets/images/Outstanding_Undergraduate_Student_in_Computer_Science_Award.jpg", style={"border-radius": "25px", "width": "100%"}),
        ], lg={'size': 6}), 
    ], justify='center', className='mb-4'),
    dbc.Row([
        dbc.Col([    
            ...
            html.P("April 2023", style={"color": "white"}),
            html.Img(src="./assets/images/Undergraduate_Tutor_Award.jpg", style={"border-radius": "25px", "width": "100%"}),
        ], lg={'size': 6}),
    ], justify='center', className='mb-4'),
    dbc.Row([
        dbc.Col([
            ...
            html.Img(src="./assets/images/SURF.JPG", style={"border-radius": "25px", "width": "100%"})
        ], lg={'size': 6}), 
    ], justify='center', className='mb-4')
])